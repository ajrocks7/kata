...
class KataEightTest extends TestCase {
    ...
    {
        $result = $this->KataEight()->add('10,20,"",4,5');
    ...
    {
        $stringCalculator = $this->KataEight();
    ...
    private function KataEight():KataEight
    {
        return new KataEight();
    }
}