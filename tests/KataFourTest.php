...
class KataFourTest extends TestCase {
    ...
    {
        $result = $this->KataFour()->add('10,20,"",4,5');
    ...
    {
        $stringCalculator = $this->KataFour();
    ...
    private function KataFour():KataFour
    {
        return new KataFour();
    }
}