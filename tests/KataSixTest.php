...
class KataSixTest extends TestCase {
    ...
    {
        $result = $this->KataSix()->add('10,20,"",4,5');
    ...
    private function KataSix():KataSix
    {
        return new KataSix();
    }
}