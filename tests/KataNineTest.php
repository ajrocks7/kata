...
class KataNineTest extends TestCase {
    ...
    {
        $result = $this->KataNine()->add('10,20,"",4,5');
    ...
    {
        $stringCalculator = $this->KataNine();
    ...
    public function test_it_adds_numbers_even_when_multiple_delimiters_are_passed():void
    {
        $stringCalculator = $this->KataNine();
    ...
    //tests inclusive of KataNine
    public function test_it_adds_numbers_even_when_more_than_one_char_of_multiple_delimiters_are_passed():void
    {
        $stringCalculator = $this->KataNine();
    ...
    private function KataNine():KataNine
    {
        return new KataNine();
    }
}